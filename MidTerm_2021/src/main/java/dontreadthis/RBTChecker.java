...
public class RBTChecker<Key extends Comparable<Key>, Value> {
    public RBNode<Key, Value> root;     // root of the BST

    public boolean checkNode(Key key, boolean col) {
        return checkNode(root, key, col);
    }

    private boolean checkNode(RBNode<Key, Value> x, Key key, boolean col) {
        while (x != null) {
            int cmp = key.compareTo(x.key);
            if      (cmp < 0) x = x.left;
            else if (cmp > 0) x = x.right;
            else              return x.color == col;
        }
        return false;
    }
     ...
     */
    public RBTChecker(RBNode<Key, Value> root) {
        this.root = root;
    }

    public void displayTree() {displayTree(root, 1);}
    private void displayTree(RBNode<Key, Value> thisNode, int level) {

        System.out.println(level+"/-"+thisNode);

        if (thisNode.left != null){
            System.out.print("lc:");
            displayTree(thisNode.left, level + 1);
        }
        if (thisNode.right != null){
            System.out.print("rc:");
            displayTree(thisNode.right, level + 1);
        }
    }
   /***************************************************************************
    *  Node helper methods.
    ***************************************************************************/
    ...
    private boolean isRed(RBNode<Key, Value> x) {
        ...
        return x.color == RBNode.RED;
    }

    // number of node in subtree rooted at x; 0 if x is null
    public int size(RBNode<Key, Value> x) {
        if (x == null) return 0;
        return x.size;
    } 
    ...
    ***************************************************************************/
    ...
    private RBNode<Key, Value> max(RBNode<Key, Value> x) {
        // assert x != null;
    ...
    ***************************************************************************/
    ...
    // to the queue
    private void keys(RBNode<Key, Value> x, java.util.Queue<Key> queue, Key lo, Key hi) {
        if (x == null) return;
